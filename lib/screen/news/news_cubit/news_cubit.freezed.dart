...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<NewsModel> model) : _model = model;
  ...
  @override
  String toString() {
    return 'NewsState.success(model: $model)';
  }
...
abstract class _Success implements NewsState {
  const factory _Success(final List<NewsModel> model) = _$SuccessImpl;
